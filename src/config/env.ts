...
export const ENV_REGISTRY: readonly EnvVarMeta[] = [
  ...
  },
  {
    ...
    description: 'Reacting goblin mini-sprite tucked at the right edge of the loop-stage footer row while the agent runs tools (1 row shared with the rail, animated). 1 = on, unset/0 = off (default). Claims no terminal rows.',
    type: 'boolean',
    required: false,
    example: '1',
    category: 'misc',
