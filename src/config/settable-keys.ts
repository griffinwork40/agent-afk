...
export const CONFIG_KEY_SPECS: readonly ConfigKeySpec[] = [
  ...
  { path: 'interactive.bashPreviewHeadLines', tier: 'agent', type: 'number', clamp: { min: 0, max: 50, integer: true }, description: 'Number of leading non-empty lines shown at the top of a bash output preview block (0 = no head preview). Range 0–50.' },
  { path: 'interactive.bashPreviewTailLines', tier: 'agent', type: 'number', clamp: { min: 0, max: 50, integer: true }, description: 'Number of trailing non-empty lines shown at the bottom of a bash output preview block. Default 7. Range 0–50.' },
