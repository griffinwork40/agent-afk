 ...
 *   - `ThrottleInterval` = 30 s: caps restart rate so a bot that exits
 *     immediately on every launch gives the operator 30 seconds to react
 *     rather than hammering the CPU at launchd's default rate.
