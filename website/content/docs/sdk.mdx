...
<Callout type="info">
You configure the whole loop — prompts, gates, routing, tools, and terminal behavior. The
package is plain TypeScript: the code you import is the code you can read and change.
</Callout>
