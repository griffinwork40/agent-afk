...
Environment variables override matching fields in `afk.config.json`. For example, `AFK_MODEL` overrides `model`. See [Environment Variables](/docs/configuration/environment-variables) for the full list.
