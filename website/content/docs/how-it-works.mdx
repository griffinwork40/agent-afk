---
title: "How It Works"
description: "How Agent AFK works: session lifecycle, Anthropic and OpenAI provider routing, tool dispatch, terminal states, and the ~/.afk/ state directory layout."
---
...
1. **Framework base** — `system-prompt.md`, inlined at build time. Unconditional; always
   present.
