...
<Cards>
  ...
  <Card title="Slash skills" href="/skills/overview" description="A registry of built-in slash commands plus auto-discovered SKILL.md plugins, with typo-tolerant matching." />
