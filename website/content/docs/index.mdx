---
title: "Introduction"
description: "Agent AFK documentation — an open-source AI agent runtime: terminal REPL, headless daemon, and Telegram bot sharing one session, memory, and tool surface."
---
