---
title: "Agent AFK — AI Agent Runtime for Your Terminal"
description: "Agent AFK is an open-source AI agent runtime: terminal REPL, headless daemon, and Telegram bot — sharing one session, memory, and tool surface."
---
