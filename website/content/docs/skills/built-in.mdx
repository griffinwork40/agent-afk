...
Plugin skills (`~/.afk/plugins/<plugin>/skills/<skill>/SKILL.md`) are discovered automatically when the plugin is installed. They surface in `/help` and tab-complete. See [Custom Skills](/docs/skills/custom) for how to author your own.
