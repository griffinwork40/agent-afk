#!/usr/bin/env tsx
/**
 * Enforce a function-scoped size ceiling. CI-blocking (exits non-zero on violations).
...
/**
 * Enforced ceiling. Extract a helper when you exceed it; the gate fails CI on
 * any violation not in the grandfathered baseline.
 *
