...
const bundledTarget: PinTarget = {
  ...
  pins: {
    ...
    diagnose: join(bundledSkillsDir, 'diagnose/SKILL.md'),
    'false-completion-gate': join(bundledSkillsDir, 'false-completion-gate/SKILL.md'),
    'fix-pr': join(bundledSkillsDir, 'fix-pr/SKILL.md'),
