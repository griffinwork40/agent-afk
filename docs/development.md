...
- The agent-afk system prompt is the framework base (`system-prompt.md`) with the operator overlay (env/config/AFK.md) appended via `resolveBaseSystemPrompt()`, sent as a raw string. No SDK preset is loaded.
